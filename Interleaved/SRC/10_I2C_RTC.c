...
void Set_InitialTime(void)
{
	...
	Write_RTC_Data(RTC_REGS_MINUTE, 0x23);		// minute
	Write_RTC_Data(RTC_REGS_HOUR, 	0x12);		// hour
	Write_RTC_Data(RTC_REGS_WEEK, 	0x03);		// week
	Write_RTC_Data(RTC_REGS_DATE, 	0x29);		// date
	Write_RTC_Data(RTC_REGS_MONTH, 	0x03);		// month
